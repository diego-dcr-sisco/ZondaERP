...
function setSedes() {
    ...
    $('#sedesList input[type="checkbox"]').each(function () {
        allCheckboxes.push({
            id: $(this).val(),
            name:
                $(this).next("label").text() || $(this).parent().text().trim(),
            is_checked: $(this).is(":checked"),
        });
    });

    const checkedItems = allCheckboxes.filter((cb) => cb.is_checked);

    const uniqueIds = new Set();
    selected_sedes = checkedItems.filter((item) => {
