...
@section('content')
    <div class="row m-0">
        ...
        <form class="form p-3" action="{{ route('payrolls.update', $payroll->id) }}" method="POST" id="payrollForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" id="folio" name="folio"
                                        value="{{ old('folio', $payroll->folio) }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <input class="form-control bg-light " type="text" id="employer_registration"
                                    name="employer_registration" value="{{ $payroll->employer_registration ?? '' }}"
                                    readonly>
                            </div>
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <input type="text" class="form-control bg-light" id="expedition_place"
                                    name="expedition_place" value="{{ $payroll->expedition_place ?? '' }}" readonly>
                            </div>

                            <div class="col-lg-3 mb-3">
                                <label class="form-label is-required">Fecha de Pago</label>
                                <input type="date" class="form-control" id="payment_date" name="payment_date"
                                    value="{{ old('payment_date', $payroll->payment_date) }}" required>
                            </div>
                            ...
                            <div class="col-lg-3 mb-3">
                                ...
                                <select class="form-select" id="payroll_type" name="payroll_type" required>
                                    @foreach ($payroll_types as $type)
                                        <option value="{{ $type->value }}" {{ $payroll->payroll_type == $type->value ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select class="form-select" id="payment_method" name="payment_method" required>
                                    @foreach ($payment_methods as $payment_method)
                                        <option value="{{ $payment_method->value }}" {{ $payroll->payment_method == $payment_method->value ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <select class="form-select" id="cfdi_use" name="cfdi_use" required>
                                    @foreach ($cfdi_usage as $usage)
                                        <option value="{{ $usage->value }}" {{ $payroll->cfdi_use == $usage->value ? 'selected' : '' }}>
                        ...
                        <div class="row">
                                ...
                                <select class="form-select" id="employee_selector" name="employee_id">
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user['id'] }}" data-rfc="{{ $user['rfc'] ?? '' }}"
                                            ...
                                            {{ $payroll->employee_id == $user['id'] ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-3 mb-3">
                                ...
                                <input type="date" class="form-control" id="start_date_labor_relations"
                                    ...
                                    value="{{ old('start_date_labor_relations', $payroll->start_date_labor_relations ? $payroll->start_date_labor_relations->format('Y-m-d') : '') }}">
                            </div>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="employee_number"
                                    ...
                                    value="{{ old('employee_number', $payroll->employee_number) }}" required>
                            </div>  
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select class="form-select" id="contract_type" name="contract_type" required>
                                    @foreach ($contract_types as $value => $label)
                                        <option value="{{ $value }}" {{ $payroll->contract_type == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select class="form-select" id="tax_regime" name="tax_regime" required>
                                    @foreach ($tax_regimes as $tax_regime)
                                        <option value="{{ $tax_regime->value }}" {{ $payroll->tax_regime == $tax_regime->value ? 'selected' : '' }}>
                                            {{ $tax_regime->value }} - {{ $tax_regime->name() }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="department" name="department"
                                    value="{{ old('department', $payroll->department) }}">
                            </div>
                            ...
                            <div class="col-lg-2 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="employee_daily_salary"
                                        ...
                                        value="{{ old('employee_daily_salary', $payroll->employee_daily_salary) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 mb-3">
                                ...
                                <select class="form-select" id="month" name="month">
                                    @foreach ($months as $m)
                                        <option value="{{ $m->value }}" {{ $payroll->month == $m->value ? 'selected' : '' }}>
                                            {{ $m->name() }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-2 mb-3">
                                ...
                                <select class="form-select" id="frequency_payment" name="frequency_payment" required>
                                    @foreach ($periodicities as $per)
                                        <option value="{{ $per->value }}" {{ $payroll->frequency_payment == $per->value ? 'selected' : '' }}>
                                            {{ $per->description() }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-2 mb-3">
                                ...
                                <input type="number" class="form-control" id="days_paid" name="days_paid"
                                    min="0" value="{{ old('days_paid', $payroll->days_paid) }}" required>
                            </div>

                            <div class="col-lg-2 mb-3">
                                <label class="form-label is-required">Rango de Fecha de Pago</label>
                                <input type="text" class="form-control date_range" id="date_range" name="date_range"
                                    placeholder="Seleccionar rango de fechas" 
                                    value="{{ old('date_range', $date_range) }}" required>
                            </div>
                            ...
                            <div class="col-lg-2 mb-3">
                                ...
                                <select class="form-select" id="position_risk" name="position_risk" required>
                                    @foreach ($position_risks as $risk)
                                        <option value="{{ $risk->value }}" {{ $payroll->position_risk == $risk->value ? 'selected' : '' }}>
                                            {{ $risk->name() }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="border rounded shadow p-3 mb-3 bg-light">
                        <div class="row">
                            <div class="col-lg-3 text-center">
                                ...
                                <h4 class="text-success" id="totalPerceptions">${{ number_format($payroll->total_perceptions, 2) }}</h4>
                            </div>
                            <div class="col-lg-3 text-center">
                                <h6>Total Deducciones</h6>
                                <h4 class="text-danger" id="totalDeductions">${{ number_format($payroll->total_deductions, 2) }}</h4>
                            </div>
                            <div class="col-lg-3 text-center">
                                <h6>Total Otros Pagos</h6>
                                <h4 class="text-info" id="totalOtherPayments">${{ number_format($payroll->total_other_payments, 2) }}</h4>
                            </div>
                            <div class="col-lg-3 text-center">
                                <h6>Total Neto</h6>
                                <h4 class="text-primary" id="totalNet">${{ number_format($payroll->total_net, 2) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <button type="submit" class="btn btn-primary" id="submitButton">
                <i class="fas fa-save me-2"></i> Actualizar Nómina
            </button>
        </form>
    </div>
    ...
    <script>
        ...
        const perceptionsData = @json($perceptionsData ?? []);
        const deductionsData = @json($deductionsData ?? []);
        ...
        // Arrays para almacenar los datos - Datos declarados
        let perceptions = @json($perceptions ?? []);
        let deductions = @json($deductions ?? []);
        let otherPayments = @json($otherPayments ?? []);
        ...
        $(document).ready(function() {
            ...
            // Si no hay datos existentes, inicializar con elementos vacíos
        ...
        function loadExistingData() {
            // Cargar percepciones existentes
            perceptions.forEach(perception => {
                addPerceptionWithData(perception);
            });

            // Cargar deducciones existentes
            deductions.forEach(deduction => {
                addDeductionWithData(deduction);
            });

            // Cargar otros pagos existentes
            otherPayments.forEach(otherPayment => {
                addOtherPaymentWithData(otherPayment);
            });

            // Actualizar totales después de cargar todos los datos
            updateTotals();
        }

        // FUNCIONES PARA AGREGAR ELEMENTOS CON DATOS EXISTENTES

        function addPerceptionWithData(perceptionData) {
            const perceptionId = perceptionData.id || 'perception_' + Date.now();
            ...
            items.forEach(item => {
                ...
                const selected = perceptionData.type == value ? 'selected' : '';
                perceptionOptions += `<option value="${value}" ${selected}>${value} - ${label}</option>`;
            });
                ...
                <tr class="perception-item" data-perception-id="${perceptionId}">
                    ...
                    <td>
                        <input type="text" class="form-control form-control-sm perception-code" 
                            value="${perceptionData.code || ''}" placeholder="Ej: 046" required>
                    </td>
                    <td>
                        <input type="text" class="form-control form-control-sm perception-description" 
                            value="${perceptionData.description || ''}" placeholder="Ej: ASIMILIADOS A SALARIOS" required>
                    </td>
                    <td>
                        <input type="number" class="form-control form-control-sm perception-taxed-amount" 
                            value="${perceptionData.taxed_amount || 0}" step="0.01" min="0" required>
                    </td>
                    <td>
                        <input type="number" class="form-control form-control-sm perception-exempt-amount" 
                            value="${perceptionData.exempt_amount || 0}" step="0.01" min="0" required>
                    </td>
                    <td>
            ...
            // Actualizar el array con los datos existentes
            const existingIndex = perceptions.findIndex(p => p.id === perceptionId);
            if (existingIndex === -1) {
                perceptions.push({
                    id: perceptionId,
                    ...
                    taxed_amount: parseFloat(perceptionData.taxed_amount) || 0,
                    exempt_amount: parseFloat(perceptionData.exempt_amount) || 0,
                    total: parseFloat(perceptionData.total) || 0
                });
            }
        ...
        function addDeductionWithData(deductionData) {
            const deductionId = deductionData.id || 'deduction_' + Date.now();
            ...
            items.forEach(item => {
                const value = item.value || item.id || item;
                const label = item.name || item.label || item.description || value;
                const selected = deductionData.type == value ? 'selected' : '';
                deductionOptions += `<option value="${value}" ${selected}>${value} - ${label}</option>`;
            });
                ...
                <tr class="deduction-item" data-deduction-id="${deductionId}">
                    ...
                    <td>
                        <input type="text" class="form-control form-control-sm deduction-code" 
                            value="${deductionData.code || ''}" placeholder="Ej: 002" required>
                    </td>
                    <td>
                        <input type="text" class="form-control form-control-sm deduction-description" 
                            value="${deductionData.description || ''}" placeholder="Ej: ISR" required>
                    </td>
                    <td>
            ...
            // Actualizar el array con los datos existentes
            const existingIndex = deductions.findIndex(d => d.id === deductionId);
            if (existingIndex === -1) {
                deductions.push({
                    id: deductionId,
        ...
        function addOtherPaymentWithData(otherPaymentData) {
            const otherPaymentId = otherPaymentData.id || 'other_payment_' + Date.now();
            ...
            for (const [key, value] of Object.entries(otherPaymentTypes)) {
                const selected = otherPaymentData.type == key ? 'selected' : '';
                otherPaymentOptions += `<option value="${key}" ${selected}>${key} - ${value}</option>`;
            }
                ...
                <tr class="other-payment-item" data-other-payment-id="${otherPaymentId}">
                    ...
                    <td>
                        <input type="text" class="form-control form-control-sm other-payment-key" 
                            value="${otherPaymentData.key || ''}" placeholder="Ej: 001" required>
                    </td>
                    <td>
                        <input type="text" class="form-control form-control-sm other-payment-concept" 
                            value="${otherPaymentData.concept || ''}" placeholder="Ej: Reintegro ISR" required>
                    </td>
                    <td>
                        <input type="number" class="form-control form-control-sm other-payment-amount" 
                            value="${otherPaymentData.amount || 0}" step="0.01" min="0" required>
                    </td>
                    <td>
            ...
            // Actualizar el array con los datos existentes
            const existingIndex = otherPayments.findIndex(op => op.id === otherPaymentId);
            if (existingIndex === -1) {
                otherPayments.push({
                    id: otherPaymentId,
                    type: otherPaymentData.type || '',
                    key: otherPaymentData.key || '',
                    concept: otherPaymentData.concept || '',
                    amount: parseFloat(otherPaymentData.amount) || 0,
                    subsidy: parseFloat(otherPaymentData.subsidy) || 0
                });
            }
        ...
        // FUNCIONES PARA AGREGAR ELEMENTOS VACÍOS
