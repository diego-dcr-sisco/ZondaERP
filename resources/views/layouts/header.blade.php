            ...
            <ul class="navbar-nav">
                ...
                @if (auth()->user()->type_id == 1)
                    <li class="nav-item dropdown">
                        <a class="nav-link fw-bold {{-- dropdown-toggle --}} text-light" data-bs-toggle="dropdown"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-lg-end">
                            <li>
                                {{-- <a class="dropdown-item text-light" href="{{ route('config.appearance') }}">
                ...
                @auth
                    <li class="nav-item dropdown">
                        <a class="nav-link fw-bold {{-- dropdown-toggle --}} header-auth" data-bs-toggle="dropdown"
                            href="#" role="button" aria-expanded="false">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link fw-bold fw-bold text-light" href="{{ route('login') }}">
