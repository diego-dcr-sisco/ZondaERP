...
Route::prefix('superadmin')
    ->name('superadmin.')
    ->middleware(['auth', 'single.session', 'can:integral', 'can:superadmin'])
    ->group(function () {
        Route::get('/dashboard', [PagesController::class, 'superAdminDashboard'])->name('dashboard');
        Route::post('/switch-tenant', [PagesController::class, 'switchTenant'])->name('switch-tenant');
    });
// CONFIGURACION
